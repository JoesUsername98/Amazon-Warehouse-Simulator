...
class Scenery():
    copyNO = 0
    def __init__(self, size, floor_ratio, storage_layout, bay_layout ):
        #Variables
        self.size = size
    ...
    def build(self):
        ...
        turtle.tracer(0, 0)
        #Make Screen
        screen = self.builder.getscreen()
        screen.colormode(255)
        turtle.title("My Turtle Program")
                                                #Colour #Box Colour #Box Layout #Path Width.
        self.Warehouse = Area(self, self.f_ratio, [255,0,0], [0,0,0], self.strg_layout, 0.4)
        self.Warehouse.draw()
        self.Bay =       Area(self, 1-self.f_ratio, [255,0,255], [0,0,0], self.bay_layout, 0.4)
        self.Bay.draw()
...
class Area(Scenery):
    ...
    def __init__(self, parent, f_ratio, colour, box_colour, box_layout, path_width):
        super().__init__(parent.size, parent.f_ratio, parent.strg_layout, parent.bay_layout)
        # in warehouse.
        self.colour = colour            
